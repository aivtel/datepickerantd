...
import warning, { formatDate, interopDefault } from './utils'
  ...
  (function(_React$Component) {
    ...
    function RangePicker(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(RangePicker).call(this, props)
      )
      ...
      _this.renderFooter = function() {
        ...
        var customFooter = renderExtraFooter
          ? React.createElement(
              'div',
              {
        ...
        var operations =
          ranges &&
          Object.keys(ranges).map(function(range) {
            var value = ranges[range]
            var hoverValue =
              typeof value === 'function'
                ? value.call(_assertThisInitialized(_this))
                : value
        ...
        var rangeNode =
          operations && operations.length > 0
            ? React.createElement(
                ...
                {
                  className: ''
                    .concat(prefixCls, '-footer-extra ')
                    .concat(prefixCls, '-range-quick-selector'),
                  key: 'range',
                },
                operations
              )
      ...
      _this.renderRangePicker = function(_ref3) {
        ...
        var calendarClassName = classNames(
          ((_classNames = {}),
          _defineProperty(_classNames, ''.concat(prefixCls, '-time'), showTime),
          _defineProperty(
            _classNames,
            ''.concat(prefixCls, '-range-with-ranges'),
            ranges
          ),
          _classNames)
        ...
        var startPlaceholder = Array.isArray(props.placeholder)
          ? props.placeholder[0]
          : locale.lang.rangePlaceholder[0]
        var endPlaceholder = Array.isArray(props.placeholder)
          ? props.placeholder[1]
            ...
            if ('value' in nextProps) {
              ...
              if (!shallowequal(nextProps.value, prevState.value)) {
                state = _extends(_extends({}, state), {
                  showDate:
                    getShowDateFromValue(value, nextProps.mode) ||
                    prevState.showDate,
                })
              }
            }
