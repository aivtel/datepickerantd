...
import warning, { interopDefault, generateShowHourMinuteSecond } from './utils'
...
function checkValidate(value, propName) {
  ...
  values.forEach(function(val) {
    ...
    warning(
      ...
      'DatePicker',
      '`'.concat(propName, '` provides invalidate moment time. If you want to set empty value, use `null` instead.'),
    )
  })
}
  ...
  var PickerWrapper =
    ...
    (function(_React$Component) {
      ...
      function PickerWrapper() {
        ...
        console.log('___ THIS ___', _this.props)
        _this.state = {}
        ...
        _this.getDefaultLocale = function() {
          ...
          var result = _extends(_extends({}, ruRU), _this.props.locale)
        ...
        _this.renderPicker = function(locale, localeCode) {
          ...
          return React.createElement(ConfigConsumer, null, function(_ref2) {
            ...
            var pickerClass = classNames(
              ...
              _defineProperty({}, ''.concat(prefixCls, '-picker-').concat(size), !!size),
            )
            var pickerInputClass = classNames(
              ''.concat(prefixCls, '-picker-input'),
              inputPrefixCls,
              ((_classNames2 = {}),
              _defineProperty(_classNames2, ''.concat(inputPrefixCls, '-lg'), size === 'large'),
              _defineProperty(_classNames2, ''.concat(inputPrefixCls, '-sm'), size === 'small'),
              _defineProperty(_classNames2, ''.concat(inputPrefixCls, '-disabled'), disabled),
              _classNames2),
            )
            ...
            var timePicker = showTime
              ? React.createElement(
                  TimePickerPanel,
                  _extends({}, rcTimePickerProps, showTime, {
