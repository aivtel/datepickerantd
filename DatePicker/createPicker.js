...
import { formatDate, interopDefault, getDataOrAriaProps } from './utils'
      ...
      function CalenderWrapper(props) {
        ...
        _this.renderPicker = function(_ref) {
          ...
          var calendarClassName = classNames(
            ((_classNames = {}),
            _defineProperty(_classNames, ''.concat(prefixCls, '-time'), props.showTime),
            _defineProperty(_classNames, ''.concat(prefixCls, '-month'), MonthCalendar === TheCalendar),
            _classNames),
          )
              ...
              (React.isValidElement(suffixIcon)
                ? React.cloneElement(suffixIcon, {
                    className: classNames(
                      ((_classNames2 = {}),
                      _defineProperty(_classNames2, suffixIcon.props.className, suffixIcon.props.className),
                      _defineProperty(_classNames2, ''.concat(prefixCls, '-picker-icon'), true),
                      _classNames2),
                    ),
                  })
                : React.createElement(
